...
export default function Onboarding() {
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: colors.absBlack}}>
      <StatusBar
        animated={true}
        backgroundColor={colors.absBlack}
        translucent={true}
      />
      <ImageBackground
        style={{flex: 1, paddingVertical: 50, paddingHorizontal: 20}}
        source={Images.ellipseBg}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={{fontSize: 68, color: colors.white, marginTop: 30}}>
          {'Connect \nfriends\neasily &\nquicky'}
        </Text>
        ...
        <View
          style={[
            {flexDirection: 'row', gap: 10, marginVertical: 20},
            commonCSS.center,
          ]}>
        ...
        <Atoms.CBtn text="Sign up with mail" />
        <TouchableOpacity>
          <Text
            style={{
              color: colors.white,
